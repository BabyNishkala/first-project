...
//---Jsx returns only one element, so to use many tags the solution is..----

    return(
        <div>
            <h1>Hai...{printName(user)}</h1>
            <h1>Hello, Everyone I am {firstName}</h1>
            <p>Welcome all, i am {secondname} </p>
        </div>
    );
}*/
// ----Date-----
/*function App(){
    return <h1> Now the time is {new Date().toLocaleTimeString()}</h1>
}*/
//--Nested components----
...
const Movie=()=>{
    return (
        <article className="each-movie">
             <img src="https://occ-0-5261-3663.1.nflxso.net/dnm/api/v6/rkETp35xJVj-6WaffQsS77awykM/AAAABQe9jDXUMj6YTYfBxD4FqwWiBK7Iyc5o36i2bm4524zCu1M_42Wu24-p_u2hVu6bH7yD7lm9HFn9clj5d2n93GSDJkn8iOaHworHyl60sUzJglRp74_srl9FuNT4LhVse6OOdRiJK0e-75jTBsNk_yKrbM_610JRVrr1ajmP5NicQaJ_niwhx4opqSReHM2FhpdAzJKNeO3OkcfTsfFjpXDHU-t10XQOhtP9w-OUekcv2HYyrsJrrxEaZbICHWaxaRlxU0UiiXrKMeb4sbIq_l2zXLnnNw3RyDpoSH28crU3HlcXpPVHV7eo.jpg?r=290" alt="netflix"/>
                <h1>Kho Gaye Hum Kahan</h1>
        </article>
    )
}
/*const InnerComponent=()=>{
    return <img src="https://occ-0-5261-3663.1.nflxso.net/dnm/api/v6/rkETp35xJVj-6WaffQsS77awykM/AAAABQe9jDXUMj6YTYfBxD4FqwWiBK7Iyc5o36i2bm4524zCu1M_42Wu24-p_u2hVu6bH7yD7lm9HFn9clj5d2n93GSDJkn8iOaHworHyl60sUzJglRp74_srl9FuNT4LhVse6OOdRiJK0e-75jTBsNk_yKrbM_610JRVrr1ajmP5NicQaJ_niwhx4opqSReHM2FhpdAzJKNeO3OkcfTsfFjpXDHU-t10XQOhtP9w-OUekcv2HYyrsJrrxEaZbICHWaxaRlxU0UiiXrKMeb4sbIq_l2zXLnnNw3RyDpoSH28crU3HlcXpPVHV7eo.jpg?r=290" alt="netflix"/>
}
const Title=()=>{
   /* const style ={
        heading:{
    ...
    return <h3 style={style.heading}>Kho Gaye Hum Kahan</h3>
    //-----inline csss------
    //return <h3 style={{color:"black", fontSize:"1.5rem"}}>Kho Gaye Hum Kahan</h3>
    return<h3>Kho Gaye Hum Kahan</h3>
}*/
//-----Props--------
/*const data =[
    {
...
/*const App=()=>{
  ...
  return (
  <h1>hello everyone
    <button className="button" onClick={name}> Click Me</button>
  </h1>)
}*/ 
function App() {
  return(
